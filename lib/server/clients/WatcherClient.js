...
module.exports = function(modelName, validation_rate) {
    let body = PS.execSync("browserify -t [ babelify --no-sourceMaps --presets [ env ] ] -e ./lib/server/clients/watcher.js", { encoding: 'utf8' });
