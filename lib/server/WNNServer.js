            ...
            let routes = {
                '/data': {
                    ...
                    GET: function (request, response, verbose) {
                        ...
                        response.writeHead(200, { 'Content-Type': 'arraybuffer', 'connection': 'keep-alive' });
                ...
                '/watch': {
                    ...
                    GET: function (request, response, verbose) {
                        ...
                        response.writeHead(200, { 'Content-Type': 'application/json', 'Content-Encoding': 'gzip', 'connection': 'keep-alive' });
