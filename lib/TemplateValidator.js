...
function config(object, path) {
    ...
    // if (object.training) {
    //     assert('Training requires a data delegate fulfilling TrainingDataSource protocol.',
    //         object.training.data_delegate &&
    //         typeof object.training.data_delegate.getBatch === 'function');
    // }

    // if (object.validation) {
    //     assert('Validation requires a data delegate fulfilling ValidationDataSource protocol.',
    //         object.validation.data_delegate && 
    //         typeof object.validation.data_delegate.getX === 'function' &&
    //         typeof object.validation.data_delegate.getY === 'function');
    ...
    //             object.validation.merge_all === true
    //          || object.validation.merge_all === false);
    // }
}
...
function model(array, path) {
    ...
    //  || array[last].loss === 'categorical_crossentropy'
